...
int menu()
{
    ...
    printf("----------------------------------------------------------------------------\n");
    printf("10. Generar una sub lista de pasajeros\n");
    printf("11. Filtrar pasajeros y generar una nueva lista  \n");
    printf("12. Clonar lista existente  \n");
    printf("13. Mostrar nueva lista  \n");
    printf("14. Cargar datos del archivo - filtrados.csv - (modo texto)\n");
    printf("15. Guardar los datos filtrados en archivo - filtrados.csv - (modo texto)\n");
