    ...
    if(this != NULL && nodeIndex>=0 && nodeIndex <= ll_len(this))
    {
        ...
        if(newNodo != NULL)
        {
            ...
            else
            {
                ...
                {
                    newNodo->pNextNode=nodoAnterior->pNextNode;
                    nodoAnterior->pNextNode=newNodo;
                    returnAux=0;
                }
            }
            this->size++;
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this!= NULL && index>=0 && index <ll_len(this))
    {
        if(index==0)
        {
            ...
            this->pFirstNode= auxNode->pNextNode;  ///arreglarrrr!!!
        }
        else
        {
            auxNode =getNode(this, index);
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this != NULL && from >=0 && to<= ll_len(this) && to > from)
    {
        ...
        if(cloneArray!= NULL)
        {
            ...
            {
                addNode(cloneArray, ll_len(cloneArray),ll_get(this, i));
            }
        }
    }
    return cloneArray;
...
{
    void* elemento=NULL;
    LinkedList* filterLinked=NULL;
    if(this!= NULL)
    {
        int tam = ll_len(this);
        filterLinked = ll_newLinkedList();
